...
class SSD_Detector:
    ...
    def preprocess(self, src_img):
        ...
        flattened_rgb_data = input_net_img.flatten()
...
if __name__ == "__main__":
    ...
    # input_img_path     = "/mnt/sda/DataSATA/UserData/zengsheng/my_workspace/dl_works/hand_keypiont_onnx_demo/test_images/daisy.jpg"
    # onnx_path          = "./onnx_files/fox_complex_144_light_RGB_noprepro_infer_quant_new.onnx"
    # onnx_path          = "../onnx_files/fox_complex_144_light_RGB_noprepro_infer_per_channel.onnx"
    onnx_path          = "/mnt/sda/DataSATA/UserData/zengsheng/my_workspace/dl_works/hand_keypiont_onnx_demo/detect_quant/detect_remove_sig_per_channel.onnx"
